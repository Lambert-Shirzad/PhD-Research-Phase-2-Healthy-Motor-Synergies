    ...
    for subjectcounter = 1:size(SubjectIDs,2)
        ...
        while numSynergy < ndim_Global+1
            ...
            if numSynergy == ndim_Global
                if RightVAF(numSynergy,1)>90 & DeltaRightVAF(numSynergy,1)<5 %& RightDOF_VAF(numSynergy,:)>50
                    ndim_R = ndim_Global;
                ...
                if LeftVAF(numSynergy,1)>90 & DeltaLeftVAF(numSynergy,1)<5 %& LeftDOF_VAF(numSynergy,:)>50
                    ndim_L = ndim_Global;
