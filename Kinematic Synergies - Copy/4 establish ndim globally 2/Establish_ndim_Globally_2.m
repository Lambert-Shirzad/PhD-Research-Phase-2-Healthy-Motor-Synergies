...
% ndim_Global = 2 from Step 3 of the analysis 
...
% % % % % %         end        
    ...
    DOFVector={'TrRol' 'TrYaw' 'TrPit' ...
        'ShFlEx' 'ShAbAd' 'ShRot' 'ElFlEx' 'ElPrSu' 'WrDev' 'WrFlEx' };
	legend(DOFVector,'location','southeast')
